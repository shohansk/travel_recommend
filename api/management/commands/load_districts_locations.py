...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for district in districts_data['districts']:
            ...
            if created:
                self.stdout.write(self.style.SUCCESS(f"District '{district['name']}' created successfully"))
            else:
                self.stdout.write(self.style.SUCCESS(f"District '{district['name']}' updated successfully"))
